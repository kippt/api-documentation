# User's clips - [Clip](https://github.com/kippt/api-documentation/blob/master/objects/clip.md) collection

    GET /api/clips/

## Description

Get user's clips, both public and private.
...
E.g.
    ...
    GET /api/clips/?include_data=list,via&since=???????
